...
class Scope:
    ...
    def setup(self, bandwidth, center, span, rbw, no_peaks):
        ...
        # self.scope.write("MEASUREMENT:MEAS1:TYPE CPOWER")
        # # self.scope.write("MEASUREMENT:ADDMEAS MEAS1")

        # # print(self.scope.query("MEASUREMENT:MEAS1:SOUrce?"))

        # self.scope.write("MEASUREMENT:MEAS1:SOUrce CH1_SV_NORMal")

        # print(self.scope.query("MEASUREMENT:MEASRange:STATE?"))

        # print(self.scope.query("MEASUREMENT:MEAS1:CPWIDTh?"))

        # self.scope.write("MEASUREMENT:MEAS1:CPWIDTh 5E+3")
    ...
    def change_settings(self, center, span, rbw, no_peaks):
